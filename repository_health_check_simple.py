#!/usr/bin/env python3
"""
Repository Health Check Script (Simple Version)
...
def main():
    ...
    if passed == total:
        print("Result: Repository is in excellent health!")
        return 0
    elif passed >= total * 0.75:
        print("Result: Repository has minor issues but is generally healthy")
        return 1
    else:
        print("Result: Repository needs attention")
        return 2
