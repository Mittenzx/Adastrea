...
def example_layout():
    # A small valid trade hub: core corridor + cargo + docking + reactor + market.
    return {
        ...
        "GridSpacing": 100,
        "Modules": [
            {"ModuleID": "M1", "ItemID": "CorridorModule", "GridPos": [0, 0, 0], "Rotation": 0, "IsCore": True},
            {"ModuleID": "M2", "ItemID": "CargoBayModule", "GridPos": [1, 0, 0], "Rotation": 0, "IsCore": False},
            {"ModuleID": "M3", "ItemID": "DockingBayModule", "GridPos": [0, 1, 0], "Rotation": 0, "IsCore": False},
            {"ModuleID": "M4", "ItemID": "ReactorModule", "GridPos": [0, 2, 0], "Rotation": 0, "IsCore": False},
            {"ModuleID": "M5", "ItemID": "MarketplaceModule", "GridPos": [1, 1, 0], "Rotation": 0, "IsCore": False},
        ],
    }
...
def main():
    ...
    ok, errors = check_station_layout(layout, meta)
    print(f"Wrote {OUT_META}")
    print(f"Wrote {OUT_EXAMPLE}")
    print(f"Example layout valid: {ok}")
    if errors:
        for e in errors:
            print("  -", e)
