...
- **`AdvancedDefenceResearch`** — *Advanced Defence Systems* (Mk3) — unlocks 9 crafts: Energy Cannon Mk3, Missile Launcher Mk3, Plasma Cannon Mk3, Point Defence Laser Mk3, Railgun Mk3, Ship Shield Generator Mk3, Torpedo Launcher Mk3, Tri Laser Mk3, Turret Weapon Mk3
- **`DefenceResearch`** — *Defence Research* (Mk2) — unlocks 11 crafts: Energy Cannon Mk2, Gravitation Generator Mk2, Missile Launcher Mk2, Plasma Cannon Mk2, Point Defence Laser Mk2, Railgun Mk2, Shield Capacitor Mk2, Ship Shield Generator Mk2, Torpedo Launcher Mk2, Tri Laser Mk2, Turret Weapon Mk2
...
| `AdvancedDefenceResearch` | Advanced Defence Systems | 3 | WeaponsLab | 9 |
...
| `DefenceResearch` | Defence Research | 2 | WeaponsLab | 11 |
